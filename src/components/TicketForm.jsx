...
import { 
  Send, User, Mail, Calendar, MessageSquare, 
  ShieldCheck, Phone, AlertTriangle, CheckCircle, X, Wrench 
} from 'lucide-react'; // Aggiunto X e Wrench
import './TicketForm.css';

// Aggiunto onClose nelle props per ricevere la funzione di chiusura da App.jsx
export const TicketForm = ({ onClose }) => { 
  ...
  if (submitted) return (
    <div className="cyber-form-container success-state">
      {/* Tasto chiusura anche nello stato di successo */}
      ...
      <div className="success-content">
        ...
        <button onClick={onClose} className="cyber-btn-secondary">CHIUDI</button>
      </div>
    </div>
  );
  ...
  return (
    <div className="cyber-form-container">
      ...
      <div className="cyber-header">
        <div className="cyber-logo"><Wrench size={32} /></div>
      ...
      <form onSubmit={handleSubmit} className="cyber-form">
        ...
        <div className={`input-group input-group-datetime ${isSlotOccupied ? 'slot-error' : ''}`}>
